...
const S5EnterOtp = () => {
  ...
  return (
    <View style={styles.s5EnterOtp}>
      <Image
        style={[styles.s5EnterOtpChild, styles.statusBarLayout]}
        resizeMode="cover"
      ...
      />
      <View style={[styles.s5EnterOtpInner, styles.enterPosition]} />
      <Text style={styles.enterOtp}>Enter OTP</Text>
      <View style={[styles.alphabeticKeyboardIphone, styles.statusBarLayout]}>
      ...
      <Image
        style={[styles.s5EnterOtpChild1, styles.enterPosition]}
        resizeMode="cover"
        source={require("../assets/vector-14.png")}
      />
      <Pressable style={styles.resendOtp} onPress={() => {}}>
