...
const S32 = ({navigation}) => {

  return (
    <View style={styles.s23NotificationInteract}>
      ...
      <Pressable
        ...
        onPress={() => {{{navigation.navigate('s33')}}}}
      >
        <Image
        ...
        <Pressable style={styles.vector} onPress={() => {{{navigation.navigate('s33')}}}}>
          <Image
