...
const S22 = ({navigation}) => {
  ...
  return (
    <View style={styles.s17MenuInteraction}>
      <Image
        style={[styles.s17MenuInteractionChild, styles.statusBarLayout]}
        resizeMode="cover"
        source={require("../assets/vector-2.png")}
      />
      <View style={styles.s17MenuInteractionItem} />
      <Text style={[styles.similar, styles.matchTypo]}>similar</Text>
      <View style={[styles.s17MenuInteractionInner, styles.groupChildLayout]}>
        <Image
      ...
      />
      <Text style={styles.sarah19}
      onPress={() => {{navigation.navigate('s23')}}}
      >Sarah, 19</Text>
      ...
      <View style={[styles.backgroundParent, styles.logOutWrapperShadowBox]}>
        ...
        <Pressable style={styles.directpe}>
